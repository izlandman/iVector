...
mixtureVariance = .10;
channelVariance = .05;
mixtureCenters_train = randn(nDims, nMixtures, nSpeakers);
mixtureCenters_test = randn(nDims, nMixtures, nSpeakers);
    ...
    for c=1:nChannels
        for m=1:nMixtures
            ...
            trainSpeechData(:,frameIndices) = ...
                ...
                repmat(mixtureCenters_train(:,m,s),1,nMixFrames) + ...
                repmat(channelCenters(:,m,s,c),1,nMixFrames);
            testSpeechData(:,frameIndices) = ...
                randn(nDims, nMixFrames)*sqrt(mixtureVariance) + ...
                repmat(mixtureCenters_test(:,m,s),1,nMixFrames) + ...
                repmat(channelCenters(:,m,s,c),1,nMixFrames);
        end
...
eer = compute_eer_2(gmmScores, answers, true);
